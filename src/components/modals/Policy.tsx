...
const Policy = ({ isOpen, closeModal, setCheck }: Props) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={() => handleClose()} className="max-w-[600px] m-4 z-10  ">
            <div className=" no-scrollbar  relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11 h-[450px] flex justify-center items-center ">
                <Image
                src="/images/logo/warning.png"
                alt=''
                width={300}
                height={300}
